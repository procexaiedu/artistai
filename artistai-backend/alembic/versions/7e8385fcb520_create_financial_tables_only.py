"""create_financial_tables_only

Revision ID: 7e8385fcb520
Revises: e103b810d7d1
Create Date: 2025-07-27 15:00:54.447714
...
revision: str = '7e8385fcb520'
down_revision: Union[str, Sequence[str], None] = 'e103b810d7d1'
...
def upgrade() -> None:
    """Upgrade schema."""
    # Os ENUMs já existem no banco, então vamos criar apenas as tabelas
